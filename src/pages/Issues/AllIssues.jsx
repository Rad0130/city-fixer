      ...
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: '2rem clamp(1rem,4vw,2rem)', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ marginBottom: '2.5rem' }}>
          <div style={{
            ...
            borderRadius: 999, padding: '0.3rem 1rem', marginBottom: '1rem',
          }}>
            <span style={{ fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.18em', color: '#a5b4fc', textTransform: 'uppercase' }}>
              ✦ Community Reports
            </span>
          </div>
          <h1 style={{
            ...
            <span style={{
              ...
              borderRadius: 999, padding: '0.2rem 0.9rem',
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            {activeFilterCount > 0 && (
              <button
                ...
                style={{
                  ...
                  color: '#f472b6', fontSize: '0.8rem', fontWeight: 600, cursor: 'pointer',
                }}
              >
            ...
            <FilterDropdown label="Category" color="#818cf8">
              {categories.map(cat => (
                <FilterBtn key={cat} label={cat} active={isSelected('categories', cat)} color="#6366f1"
            ...
            <FilterDropdown label="Status" color="#34d399">
              {allStatus.map(s => (
                <FilterBtn key={s} label={s} active={isSelected('status', s)} color="#10b981"
            ...
            <FilterDropdown label="Priority" color="#f472b6">
              {priority.map(p => (
                <FilterBtn key={p} label={p} active={isSelected('priority', p)} color="#ec4899"
...
const FilterDropdown = ({ label, color, children }) => (
  <div className="dropdown dropdown-end">
    <div tabIndex={0} role="button" style={{
      ...
      color: color || '#fff', fontSize: '0.85rem', fontWeight: 600,
    ...
    <ul tabIndex="-1" className="dropdown-content" style={{
      ...
      minWidth: 160, marginTop: '0.4rem',
      boxShadow: '0 20px 60px rgba(0,0,0,0.5)',
      listStyle: 'none', zIndex: 100,
    }}>
      {children}
    </ul>
  </div>
